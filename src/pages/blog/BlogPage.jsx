...
const BlogPage = () => {
    return (
        <div className="min-h-[80vh] bg-white flex items-center justify-center overflow-hidden px-6 relative py-20 lg:py-32">
            {/* Background Decorations - Subtly light with brand Teal */}
            ...
            <div className="container mx-auto max-w-4xl relative z-10 text-center">
                ...
                >
                    Stories & <br />
                    <span className="text-brand-100 italic font-light">Industry Insights</span>
                </motion.h1>
                ...
                >
                    We're curating deep dives, organizer success stories, and product 
                    milestones. Get ready for a new perspective on the event world.
                </motion.p>
                ...
                >
                    ...
                    Subscribers will receive early access and exclusive partner content.
                </motion.p>

                {/* Categories Placeholder */}
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-40 border-t border-slate-100 pt-16">
                    <div className="text-center">
                        <BookOpen className="w-8 h-8 text-brand-200 mx-auto mb-4" />
                        <h4 className="text-slate-900 font-semibold mb-2 text-lg">Case Studies</h4>
                        <p className="text-slate-500 text-sm">Real organizer results.</p>
                    </div>
                    <div className="text-center md:border-x border-slate-100 font-serif">
                        <Zap className="w-8 h-8 text-brand-200 mx-auto mb-4" />
                        <h4 className="text-slate-900 font-semibold mb-2 text-lg">Product News</h4>
                        <p className="text-slate-500 text-sm">Feature deep-dives.</p>
                    </div>
                    <div className="text-center">
                        <Heart className="w-8 h-8 text-brand-100 mx-auto mb-4" />
                        <h4 className="text-slate-900 font-semibold mb-2 text-lg">Community</h4>
                        <p className="text-slate-500 text-sm">Interviews & spotlights.</p>
                    </div>
                </div>
            </div>
        </div>
