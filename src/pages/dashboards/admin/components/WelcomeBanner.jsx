...
function WelcomeBanner({ user }) {
    return (
        <motion.div
            ...
            className="relative overflow-hidden rounded-3xl bg-gradient-to-r from-purple-600 via-brand-200 to-brand-300 p-8 text-white mb-8"
        >
            ...
            <div className="absolute inset-0 overflow-hidden">
                ...
                <div className="absolute inset-0 opacity-10">
                    ...
                    <div className="absolute top-12 left-16 w-2 h-2 bg-white rounded-full" />
                    <div className="absolute top-16 left-24 w-2 h-2 bg-white rounded-full" />
                    <div className="absolute bottom-8 right-8 w-2 h-2 bg-white rounded-full" />
                    <div className="absolute bottom-12 right-16 w-2 h-2 bg-white rounded-full" />
                </div>
            </div>
            ...
            <div className="relative flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
                ...
                >
                    <motion.button
                        className="px-6 py-3 bg-white text-brand-200 rounded-xl font-semibold flex items-center gap-2 shadow-lg shadow-black/10"
